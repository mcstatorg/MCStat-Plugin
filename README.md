...
| Package | Use it for |
| --- | --- |
| `McStat-Spigot-1.1.4.jar` | Bukkit, CraftBukkit, Spigot, Paper, Purpur, Pufferfish, Folia, and Bukkit-compatible hybrid servers such as Mohist, Arclight, Magma, and CatServer |
| `McStat-Velocity-1.1.4.jar` | Velocity 3.x proxy networks |
| `McStat-BungeeCord-1.1.4.jar` | BungeeCord and Waterfall proxy networks |
...
- `spigot/target/McStat-Spigot-1.1.4.jar`
- `velocity/target/McStat-Velocity-1.1.4.jar`
- `bungee/target/McStat-BungeeCord-1.1.4.jar`
